...
Route::group(['namespace' => 'Botble\Marketplace\Http\Controllers', 'middleware' => ['web', 'core']], function () {
    Route::group(['prefix' => BaseHelper::getAdminPrefix(), 'middleware' => 'auth'], function () {
        Route::group(['prefix' => 'marketplaces', 'as' => 'marketplace.'], function () {
            ...
            Route::get('kyc', [
                'as' => 'kyc',
                'uses' => 'UnverifiedVendorController@getKYC',
            ]);
            ...
            // Route::group(['prefix' => 'plans', 'as' => 'kyc-vendors.'], fplansunction () {
            ...
            Route::group(['prefix' => 'kyc-vendors', 'as' => 'kyc-vendors.'], function () {
                Route::match(['GET', 'POST'], '/', [
                    'as' => 'index',
                    'uses' => 'UnverifiedVendorController@getKYC',
                ]);
                ...
                Route::get('view/{id}', [
                    'as' => 'view',
                    'uses' => 'UnverifiedVendorController@viewKYC',
                    'permission' => 'marketplace.unverified-vendors.edit',
                ])->wherePrimaryKey();

                Route::get('approve/{id}', [
                    'as' => 'approve-vendor',
                    'uses' => 'UnverifiedVendorController@approveKYC',
                    'permission' => 'marketplace.unverified-vendors.edit',
                ])->wherePrimaryKey();
            });
