...
return [
    ...
    'email' => [
        ...
        'verify_vendor_title' => 'Verify User',
        'verify_vendor_description' => 'Send email to the admin when a User registers',
        'pending_product_approval_title' => 'Pending product approval',
        'pending_product_approval_description' => 'Send email to the admin when a user post their products',
        'vendor_account_approved_title' => 'User account approved',
        'vendor_account_approved_description' => 'Send email to user when their account approved',
        'product_approved_title' => 'Product approved',
        'product_approved_description' => 'Send email to user when their product approved',
        'withdrawal_approved_title' => 'Withdrawal approved',
        'withdrawal_approved_description' => 'Send email to user when their withdrawal request approved',
    ],
    ...
    'settings' => [
        ...
        'check_valid_signature' => 'Check valid signature in user\'s earnings',
        'verify_vendor' => 'User verification (User just can post their product listing after getting verified)',
        ...
        'allow_vendor_manage_shipping' => 'Allow user manage shipping?',
    ...
    'theme_options' => [
        ...
        'logo_vendor_dashboard' => 'Logo in the user dashboard (Default is the main logo)',
    ],
    ...
    'helpers' => [
        'customer_status' => 'If you change the status other than ":status" this user\'s store will also change to ":store"',
