                        ...
                        <div class="header-items header__center">
                            @if (is_plugin_active('ecommerce'))
                                <form class="form--quick-search" action="{{ route('public.products') }}" data-ajax-url="{{ route('public.ajax.search-products') }}" method="get">
                                    ...
                                    <!-- <div class="form-group--icon" style="">
                                        ...
                                        <select class="form-control product-location-select" name="tags[]">
                                            <option value="0">All Tags</option>
                                            @php
                                                $tags = Botble\Ecommerce\Models\ProductTag::all();
                                            @endphp
                                        {!! Theme::partial('product-categories-select', ['categories' => $tags->toArray(), 'indent' => null]) !!}
                                        </select>
                                    </div> -->
                                    <style>
                ...
                <div class="header-wrapper">
                    <nav class="navigation">
                        <div class="container-xxxl">
                            ...
                            <div class="navigation__center" style="position: relative;">
                                {!! Menu::renderMenuLocation('main-menu', [
                                    'view'    => 'menu',
                                    'options' => ['class' => 'menu'],
                                ]) !!}
                                <a class="menu--product-categories list-now" href="{{ url('vendor/products') }}">List Now</a>
                            </div>
