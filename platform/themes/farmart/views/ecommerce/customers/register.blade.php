                            ...
                            @if (is_plugin_active('marketplace'))
                                ...
                                <div class="vendor-customer-registration">
                                    ...
                                    <div class="form-check my-1 mb-3">
                                        <input type="hidden" name="is_vendor" id="vendor-role-register" value="1" />
                                        <!-- <input class="form-check-input" id="vendor-role-register" value="1"
                                               type="radio" name="is_vendor" checked="checked">
...
<script>
    document.getElementById('email-register').addEventListener('input', function() {
        ...
        document.getElementById('shop-name-register').value = nameValue;
        document.getElementById('shop-url-register').value = nameValue;
    });
</script>