...
(function($) {
    ...
    function basicEvents() {
        ...
        // let $locationLabel = $('.product-location-label .text')
        // $(document).on('change', '.product-location-select', function() {
        //     $locationLabel.text($.trim($(this).find('option:selected').text()))
        // })

        // $locationLabel.text(
        //     $.trim($('.product-location-select option:selected').text()),
        // )
